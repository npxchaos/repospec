...
- c8c1c28: Add the `claude-agents` adapter (tenth built-in): it projects each
...
- Updated dependencies [c8c1c28]
  - @repospec/engine@0.10.0
...
- 185af5c: `bootstrap` now seeds the prose documents from a repository's existing docs
...
- Updated dependencies [7e1a7fd]
- Updated dependencies [7c6e8f9]
  - @repospec/protocol@0.7.0
  - @repospec/engine@0.7.0
