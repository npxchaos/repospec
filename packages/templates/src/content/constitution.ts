...
/**
 * Render the seed `constitution.md` — the non-negotiable engineering
 * principles for the project. Seeded once; owned by humans thereafter.
 *
 * @param project - The project configuration gathered at init.
 * @returns Markdown for `.repospec/constitution.md`.
 */
export function constitution(project: Project): string {
  return `# Constitution — ${project.project.name}
